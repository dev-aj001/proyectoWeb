...
<div class="font-[sans-serif] bg-white text-[#333] md:h-screen">
  ...
  <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
    <form class="space-y-6 form-margin"  method="POST"  >
        ...
        <div class="mt-2">
          <input id="nombre" name="nombre" type="text"  required class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"  bind:value={nombre}> 
        </div>
      </div>
      <div>
    ...
    <div>
        <button on:click={signUp} type="submit" class="flex w-full justify-center rounded-md  bg-[#025E73] px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-[#F25C05] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:bg-[#037F8C]">Registrarse</button>
      </div>
      <div>
      <button on:click={register} class="bg-white shadow-md px-3 py-1.5 rounded-lg flex items-center space-x-4 text-gray-700 min-w-60">
    ...
    <p class="mt-10 text-center text-sm text-gray-500">
      ...
      <a href="/login" class="font-semibold leading-6 text-[#F25C05] hover:text-bg-gray-900">Inicia ahora</a>
    </p>
  </div>
</div>
        </div>
